...
**Participants in the Choral Tour are [strongly recommended to carry travel insurance]({{ site.baseurl }}{% link getting-here.md %}#travel-insurance) in case of cancellation or trip interruption.**
{%- else -%}
[Travel insurance is strongly recommended]({{ site.baseurl }}{% link getting-here.md %}#travel-insurance) for your protection in case of cancellation or trip interruption.{% endif %}
{% unless reference-program -%}
**Participants in the Choral Tour are required to carry travel insurance.**
{%- endunless %}
No refunds are available for partial use of program.
