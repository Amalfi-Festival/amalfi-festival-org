...
{%- else -%}
[Travel insurance is strongly recommended]({{ site.baseurl }}{% link getting-here.md %}#travel-insurance) for your protection in case of cancellation or trip interruption.
{% endif %}
